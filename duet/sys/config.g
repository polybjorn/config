...
M92 X80.00 Y80.00 Z400.00 E679.06             ; set steps per mm
...
M671 X296:-85:296 Y-75:110:342 S2             ; Z leadscrew positions

; Z-Probe
M950 S0 C"io7.out"                            ; create servo pin 0 for BLTouch
M558 P9 C"io7.in" H5 F120 T6000               ; set Z probe type to bltouch and the dive height + speeds
G31 P500 X41 Y0 Z2.567                        ; set Z probe trigger value, offset and trigger height
M557 X46:245 Y5:287 S40:50                    ; define mesh grid
...
M307 H1 R1.881 K0.428:0.137 D3.64 E1.35 S1 B0 ; disable bang-bang mode for heater  and set PWM limit
...
M106 P1 C"Layer fan" S1 H-1                   ; set fan 1 name and value. Thermostatic control is turned off

; Tools
M563 P0 S"Titan Aero" D0 H1 F0:1              ; define tool 0
G10 P0 X0 Y0 Z0                               ; set tool 0 axis offsets
G10 P0 R0 S0                                  ; set initial tool 0 active and standby temperatures to 0C
M572 D0 S0.05                                 ; Pressure advance (E3D Titan Aero)
